...
class PatternService:
    ...
    def deprecate_pattern(
        self, name: str, reason: str, replacement_pattern: Optional[str] = None
    ) -> None:
    ...
    def find_similar_patterns(
        self, pattern_id: int, limit: int = 10, min_similarity: float = 0.5
    ) -> List[Tuple[Pattern, float]]:
        """
    ...
    def recommend_patterns_for_entity(
        self, entity_description: str, field_names: List[str], limit: int = 5
    ) -> List[Tuple[Pattern, float]]:
        """
