"""
Reverse Python subcommand - Convert Django/FastAPI models to SpecQL YAML.
"""
...
@click.option(
    "--framework",
    type=click.Choice(["django", "fastapi", "flask", "sqlalchemy"]),
...
def python(files, output_dir, framework, preview, **kwargs):
    ...
    Supports Django, FastAPI, Flask-SQLAlchemy, and SQLAlchemy models.
    ...
    with handle_cli_error():
        ...
        # TODO: Integrate with existing Python reverse engineering
        ...
        output.success(f"Phase 3 reverse python command processed {processed_count} file(s)")
        output.warning("Full Python reverse engineering integration pending in Phase 4")
