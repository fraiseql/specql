...
def seed_crm_contact_template(library: PatternLibrary):
    ...
    library.add_entity_template(
        ...
        default_fields={
            ...
            "source": {
                "type": "enum",
                "values": ["website", "referral", "import", "manual"],
            },
            "tags": {"type": "array"},
            "notes": {"type": "text"},
        },
        ...
        default_actions={
            "qualify": {
                ...
                "steps": [
                    {
                        "type": "validate",
                        "condition": "state == 'lead'",
                        "error": "Can only qualify leads",
                    },
                    {
                        "type": "validate",
                    ...
                    },
                    {
                        ...
                        "args": {"target_state": "prospect", "user_id": "$user_id"},
                    },
                ],
            },
            "convert_to_customer": {
                ...
                "steps": [
                    {
                        "type": "validate",
                        "condition": "state == 'qualified'",
                        "error": "Can only convert qualified prospects",
                    },
                    {
                        "type": "call",
                        "function": "transition_to",
                        "args": {"target_state": "customer", "user_id": "$user_id"},
                    },
                    {
                        "type": "notify",
                        "recipients": ["sales_team"],
                        "message": "New customer: {first_name} {last_name}",
                    },
                ],
            },
            "update_contact_info": {
...
def seed_crm_lead_template(library: PatternLibrary):
    ...
    library.add_entity_template(
        ...
        default_fields={
            ...
            "source": {
                "type": "enum",
                "values": ["website", "referral", "cold_outreach", "event", "import"],
            },
            "campaign": {"type": "text"},
            # Qualification
            ...
            "timeline": {
                "type": "enum",
                "values": ["immediate", "1-3_months", "3-6_months", "6+_months"],
            },
            "authority": {
                "type": "enum",
                "values": ["decision_maker", "influencer", "user"],
            },
            # Tracking
                ...
                "steps": [
                    {
                        ...
                        "entity": "Lead",
                        "where": "id = $id",
                        "fields": {"score": "score + $points"},
                    },
                    {
                        "type": "log",
                        "message": "Lead score updated: +{points} points ({reason})",
                    },
                ],
            },
            "schedule_followup": {
                ...
                "steps": [
                    {
                        ...
                        "entity": "Lead",
                        "where": "id = $id",
                        "fields": {"next_followup": "$followup_date"},
                    },
                    {
                        "type": "log",
                        "message": "Followup scheduled for {followup_date}",
                    },
                ],
            },
        },
        ...
        default_actions={
            "update_probability": {
                ...
                "steps": [
                    ...
                    {
                        "type": "log",
                        "message": "Probability updated to {probability}%: {reason}",
                    },
                ],
            },
            "change_stage": {
                ...
                "steps": [
                    {
                        "type": "call",
                        "function": "transition_to",
                        "args": {"target_state": "$new_stage", "user_id": "$user_id"},
                    },
                    {
                        "type": "if",
                        "condition": "new_stage IN ('closed_won', 'closed_lost')",
                        "then": [
                            {
                                "type": "update",
                                "entity": "Opportunity",
                                "where": "id = $id",
                                "fields": {"actual_close_date": "NOW()"},
                            }
                        ],
                    },
                ],
...
def seed_crm_account_template(library: PatternLibrary):
    ...
    library.add_entity_template(
        ...
        default_fields={
            ...
            "type": {
                "type": "enum",
                "values": ["prospect", "customer", "partner", "competitor"],
            },
        ...
        default_patterns={
            ...
            "tagging": {"enable_categories": True, "allow_custom_tags": True},
        },
        default_actions={
            "add_contact": {
                "description": "Add a contact to this account",
                "parameters": [{"name": "contact_id", "type": "uuid"}],
                "steps": [
                    {
                        "type": "validate",
                    ...
                    {
                        "type": "log",
                        "message": "Contact {contact_id} added to account {id}",
                    },
                ],
            },
            "set_primary_contact": {
                ...
                "steps": [
                    ...
                    },
                    {
                        ...
                        "entity": "Account",
                        "where": "id = $id",
                        "fields": {"primary_contact": "$contact_id"},
                    },
    ...
    library.add_entity_template(
        ...
        default_actions={
                ...
                "steps": [
                    {
                        ...
                        "entity": "Product",
                        "where": "id = $id",
                        "fields": {"inventory_quantity": "$quantity"},
                    },
                    {
                        "type": "log",
                        "message": "Inventory updated to {quantity}: {reason}",
                    },
                ],
            },
            "publish_product": {
                ...
                "steps": [
                    {
                        ...
                        "error": "Product must be in draft status",
                    },
                    {
                        "type": "validate",
                        "condition": "name IS NOT NULL AND price IS NOT NULL",
            ...
            "add_variant": {
                ...
                "parameters": [{"name": "variant_data", "type": "object"}],
                "steps": [
                    {
                        "type": "update",
                        "entity": "Product",
                        "where": "id = $id",
                        "fields": {"variants": "variants || $variant_data"},
                    },
        ...
        default_actions={
            "add_line_item": {
                ...
                "steps": [
                    ...
                    {
                        "type": "query",
                        "sql": "SELECT inventory_quantity, inventory_policy FROM products WHERE id = $product_id",
                        "into": "product",
                    },
                    {
                        "type": "validate",
                        "condition": "product.inventory_quantity >= quantity OR product.inventory_policy == 'allow'",
                    ...
                    },
                    {
                        ...
                        "where": "id = $id",
                        "fields": {
                            "line_items": "line_items || {'product_id': $product_id, 'quantity': $quantity, 'price': $price}"
                        },
                    },
                    {
                        "type": "update",
            ...
            "recalculate_total": {
                ...
                "steps": [
                    {
                        "type": "query",
                        "sql": "SELECT line_items FROM orders WHERE id = $id",
                        "into": "order_data",
                    },
                    {
                        "type": "assign",
                        "variable": "subtotal",
                        "value": "sum(item.price * item.quantity for item in order_data.line_items)",
                    },
                    {
                        "type": "assign",
                        "variable": "tax_amount",
                    ...
                    },  # 8% tax
                    {
                        "type": "assign",
                        "variable": "total",
                        "value": "subtotal + tax_amount + shipping_amount - discount_amount",
                    },
                    {
                        "type": "update",
                        "entity": "Order",
            ...
            "process_refund": {
                ...
                "steps": [
                    ...
                    {
                        "type": "validate",
                        "condition": "refund_amount <= total",
                        "error": "Refund amount cannot exceed order total",
                    },
                    {
                        "type": "call",
                        "function": "transition_to",
                        "args": {"target_state": "refunded"},
                    },
                    {
                        "type": "log",
                        "message": "Order refunded: ${refund_amount} - {reason}",
                    },
                ],
            },
        },
        ...
        default_actions={
            "add_item": {
                ...
                "steps": [
                    ...
                    {
                        "type": "query",
                        "sql": "SELECT id, price, inventory_quantity FROM products WHERE id = $product_id",
                        "into": "product",
                    },
                    {
                        "type": "validate",
                    ...
                    {
                        "type": "assign",
                        "variable": "existing_item",
                        "value": "next((item for item in line_items if item.product_id == product_id and item.variant_id == variant_id), None)",
                    },
                    {
                        "type": "if",
                        "condition": "existing_item",
                        "then": [
                            {
                                "type": "update",
                                "entity": "Cart",
                                "where": "id = $id",
                                "fields": {
                                    "line_items": "update_item_quantity(line_items, product_id, variant_id, existing_item.quantity + quantity)"
                                },
                            }
                        ],
                        "else": [
                            {
                                ...
                                "where": "id = $id",
                                "fields": {
                                    "line_items": "line_items || {'product_id': $product_id, 'quantity': $quantity, 'price': product.price, 'variant_id': $variant_id}"
                                },
                            }
                        ],
                    },
                    {"type": "call", "function": "recalculate_total"},
                    {
                        ...
                        "entity": "Cart",
                        "where": "id = $id",
                        "fields": {"expires_at": "NOW() + INTERVAL '24 hours'"},
                    },
                ],
            },
            "remove_item": {
                ...
                "steps": [
                    {
                        ...
                        "where": "id = $id",
                        "fields": {
                            "line_items": "remove_item(line_items, product_id, variant_id)"
                        },
                    },
                    {"type": "call", "function": "recalculate_total"},
                ],
            ...
            "apply_discount": {
                ...
                "steps": [
                    {
                        "type": "query",
                        "sql": "SELECT * FROM discount_codes WHERE code = $code AND active = true",
                        "into": "discount",
                    },
                    {
                        "type": "validate",
                        "condition": "discount.id IS NOT NULL",
                        "error": "Invalid discount code",
                    },
                    {
                        "type": "validate",
                        "condition": "code NOT IN discount_codes",
                    ...
                    },
                    {
                        ...
                        "entity": "Cart",
                        "where": "id = $id",
                        "fields": {"discount_codes": "discount_codes || $code"},
                    },
                    {"type": "call", "function": "recalculate_total"},
                ],
            },
            "convert_to_order": {
                ...
                "steps": [
                    ...
                    {
                        "type": "validate",
                        "condition": "customer IS NOT NULL",
                ...
                "steps": [
                    {
                        "type": "assign",
                        "variable": "subtotal",
                        "value": "sum(item.price * item.quantity for item in line_items)",
                    },
                    {
                        "type": "assign",
                        "variable": "discount_amount",
                        "value": "calculate_discount_amount(subtotal, discount_codes)",
                    },
                    {
                        "type": "assign",
                        "variable": "tax_amount",
                        "value": "(subtotal - discount_amount) * 0.08",
                    },
                    {
                        "type": "assign",
                        "variable": "total",
                        "value": "subtotal - discount_amount + tax_amount + shipping_amount",
                    },
                    {
                        "type": "update",
                        "entity": "Cart",
    ...
    library.add_entity_template(
        ...
        default_actions={
            "add_payment_method": {
                ...
                "parameters": [{"name": "payment_data", "type": "object"}],
                "steps": [
                    {
                        "type": "validate",
                        "condition": "payment_data.type IN ('credit_card', 'paypal', 'bank_account')",
                    ...
                    },
                    {
                        ...
                        "where": "id = $id",
                        "fields": {
                            "payment_methods": "payment_methods || $payment_data"
                        },
                    },
                ...
                "steps": [
                    {
                        ...
                        "entity": "Customer",
                        "where": "id = $id",
                        "fields": {"loyalty_points": "loyalty_points + $points"},
                    },
                    {"type": "call", "function": "update_loyalty_tier"},
                    {
                        "type": "log",
                        "message": "Loyalty points updated: {points} ({reason})",
                    },
                ],
            },
            "update_loyalty_tier": {
                ...
                "steps": [
                    {
                        "type": "assign",
                        "variable": "new_tier",
                        "value": "'platinum' if total_spent > 5000 else 'gold' if total_spent > 2000 else 'silver' if total_spent > 500 else 'bronze'",
                    },
                    {
                        "type": "if",
                        "condition": "new_tier != loyalty_tier",
                        "then": [
                            {
                                "type": "update",
                                "entity": "Customer",
                                "where": "id = $id",
                                "fields": {"loyalty_tier": "$new_tier"},
                            },
                            {
                                "type": "log",
                                "message": "Loyalty tier updated to {new_tier}",
                            },
                        ],
                    },
                ],
                ...
                "steps": [
                    {
                        ...
                        "where": "id = $id",
                        "fields": {
                            "saved_addresses": "saved_addresses || $address_data"
                        },
                    },
                    {
                        "type": "if",
                        "condition": "set_as_default",
                        "then": [
                            {
                                "type": "update",
                                "entity": "Customer",
        ...
        configuration_options={
            ...
            "tier_thresholds": {
                "type": "object",
                "default": {"silver": 500, "gold": 2000, "platinum": 5000},
            },
        ...
        default_patterns={
            ...
            "computed_fields": {
                "computed_fields": {
                    ...
                    "is_minor": {"type": "expression", "expression": "age < 18"},
        ...
        default_actions={
            "update_medical_record": {
                ...
                "steps": [
                    ...
                    {
                        "type": "log",
                        "message": "Medical record updated by provider {provider_id}",
                    },
                ],
            },
            "record_visit": {
                ...
                "steps": [
                    {
                        ...
                        "entity": "Patient",
                        "where": "id = $id",
                        "fields": {"last_visit_date": "$visit_date"},
                    },
                    {
                        "type": "create",
                        "entity": "Visit",
                ...
                "steps": [
                    {
                        ...
                        "entity": "Patient",
                        "where": "id = $id",
                        "fields": {"consent_given": True, "consent_date": "NOW()"},
                    },
                ...
                "steps": [
                    {
                        ...
                        "where": "id = $id",
                        "fields": {
                            "allergies": "allergies || {'allergy': $allergy, 'severity': $severity, 'date_added': NOW()}"
                        },
                    },
        ...
        default_actions={
            "schedule_appointment": {
                ...
                "steps": [
                    ...
                    {
                        "type": "query",
                        "sql": "SELECT id FROM appointments WHERE provider_id = $provider_id AND scheduled_date <= $scheduled_date AND end_time > $scheduled_date",
                        "into": "conflicts",
                    },
                    {
                        "type": "validate",
                        "condition": "len(conflicts) == 0",
                        "error": "Provider has scheduling conflict",
                    },
                    {
                        "type": "create",
                        "entity": "Appointment",
                ...
                "steps": [
                    {
                        ...
                        "error": "Cannot reschedule appointment with status: {status}",
                    },
                    {
                        "type": "query",
                        "sql": "SELECT id FROM appointments WHERE provider_id = provider AND new_date <= $new_date AND end_time > $new_date",
                        "into": "conflicts",
                    },
                    {
                        "type": "validate",
                    ...
                    },
                    {
                        ...
                        "fields": {
                            ...
                            "end_time": "$new_date + INTERVAL 'duration_minutes minutes'",
                        },
                    },
                ...
                "steps": [
                    {
                        ...
                        "error": "Appointment must be confirmed",
                    },
                    {
                        "type": "validate",
                        "condition": "scheduled_date <= NOW() + INTERVAL '15 minutes'",
            ...
            "send_reminder": {
                ...
                "steps": [
                    {
                        "type": "validate",
                        "condition": "NOT reminder_sent",
                        "error": "Reminder already sent",
                    },
                    {
                        "type": "query",
                        "sql": "SELECT email, phone FROM patients WHERE id = patient",
                        "into": "patient_contact",
                    },
                    {
                        "type": "notify",
                        "recipients": ["$patient_contact.email"],
                        "message": "Appointment reminder: {scheduled_date} with {provider.name}",
                    },
                    {
                        "type": "update",
                        "entity": "Appointment",
                        "where": "id = $id",
                        "fields": {"reminder_sent": True, "reminder_sent_at": "NOW()"},
                    },
                ],
            },
        },
            ...
            "validation_chain": {
                "rules": [
                    ...
                    },
                    {
                        ...
                        "rule": "dea_validation",
                        "error": "DEA validation required for controlled substances",
                    },
                ]
            },
        },
        default_actions={
            "prescribe_medication": {
                ...
                "steps": [
                    ...
                    {
                        "type": "validate",
                        "condition": "days_supply > 0",
                        "error": "Days supply must be positive",
                    },
                    {
                        "type": "create",
                        "entity": "Prescription",
                    ...
                    {
                        "type": "log",
                        "message": "Prescription created: {medication} {dosage}",
                    },
                ],
            },
            "refill_prescription": {
                ...
                "steps": [
                    {
                        "type": "validate",
                        "condition": "can_refill",
                        "error": "Prescription cannot be refilled",
                    },
                    {
                        "type": "validate",
                        "condition": "last_refill_date IS NULL OR NOW() > last_refill_date + INTERVAL '1 day'",
                        "error": "Too soon for refill",
                    },
                    {
                        "type": "update",
                        "entity": "Prescription",
                    ...
                    {
                        "type": "log",
                        "message": "Prescription refilled, {refills_remaining} refills remaining",
                    },
                ],
            },
            "discontinue_prescription": {
                "description": "Discontinue prescription",
                "parameters": [{"name": "reason", "type": "text"}],
                "steps": [
                    {
                        "type": "validate",
            ...
            "record_fill": {
                ...
                "steps": [
                    ...
                    {
                        "type": "log",
                        "message": "Prescription filled at {pharmacy}: {quantity_filled} units",
                    },
                ],
            },
        },
...
def seed_healthcare_provider_template(library: PatternLibrary):
    ...
    library.add_entity_template(
        ...
        default_fields={
            ...
            "employment_status": {
                "type": "enum",
                "values": ["active", "inactive", "retired", "terminated"],
                "default": "active",
            },
            "hire_date": {"type": "date"},
            ...
            "validation_chain": {
                "rules": [
                    ...
                    },
                    {
                        ...
                        "rule": "future_date",
                        "error": "License expiration must be in the future",
                    },
                    {
                        "field": "specialty",
                        "rule": "not_empty",
        ...
        default_actions={
            "update_credentials": {
                ...
                "parameters": [{"name": "credentials", "type": "object"}],
                "steps": [
                    {
                        "type": "validate",
                        "condition": "credentials.license_expiration > NOW()",
                        "error": "License cannot be expired",
                    },
                    {
                        "type": "update",
                        "entity": "Provider",
                ...
                "steps": [
                    {
                        ...
                        "where": "id = $id",
                        "fields": {
                            "board_certifications": "board_certifications || {'certification': $certification, 'issue_date': $issue_date, 'expiration_date': $expiration_date}"
                        },
                    },
            ...
            "update_schedule": {
                ...
                "parameters": [{"name": "working_hours", "type": "object"}],
                "steps": [
                    {
                        "type": "validate",
                        "condition": "validate_working_hours($working_hours)",
            ...
            "get_availability": {
                ...
                "steps": [
                    {
                        "type": "query",
                        "sql": "SELECT working_hours, appointment_types FROM providers WHERE id = $id",
                        "into": "provider_info",
                    },
                    {
                        "type": "query",
                        "sql": "SELECT scheduled_date, duration_minutes FROM appointments WHERE provider_id = $id AND DATE(scheduled_date) = $date AND status IN ('scheduled', 'confirmed')",
                        "into": "existing_appointments",
                    },
                    {
                        "type": "assign",
                        "variable": "available_slots",
                        "value": "calculate_available_slots(provider_info.working_hours, existing_appointments, $appointment_type)",
                    },
    ...
    library.add_entity_template(
        ...
        default_actions={
            "create_task": {
                ...
                "parameters": [{"name": "task_data", "type": "object"}],
                "steps": [
                    {
                        "type": "validate",
                        "condition": "status IN ('planning', 'active')",
                        "error": "Cannot add tasks to project with status: {status}",
                    },
                    {"type": "create", "entity": "Task", "data": "$task_data"},
                    {
                        ...
                        "entity": "Project",
                        "where": "id = $id",
                        "fields": {"total_tasks": "total_tasks + 1"},
                    },
            ...
            "add_milestone": {
                ...
                "parameters": [{"name": "milestone_data", "type": "object"}],
                "steps": [
                    {
                        "type": "create",
                        "entity": "Milestone",
            ...
            "update_progress": {
                ...
                "steps": [
                    {
                        "type": "query",
                        "sql": "SELECT COUNT(*) as total, COUNT(CASE WHEN status = 'completed' THEN 1 END) as completed FROM tasks WHERE project_id = $id",
                        "into": "task_stats",
                    },
                    {
                        "type": "assign",
                        "variable": "progress",
                        "value": "(task_stats.completed / task_stats.total) * 100 if task_stats.total > 0 else 0",
                    },
                    {
                        "type": "update",
                        "entity": "Project",
            ...
            "add_team_member": {
                ...
                "steps": [
                    {
                        "type": "validate",
                        "condition": "user_id NOT IN team_members",
                    ...
                    },
                    {
                        ...
                        "where": "id = $id",
                        "fields": {
                            "team_members": "team_members || {'user_id': $user_id, 'role': $role, 'added_date': NOW()}"
                        },
                    },
                    {
                        "type": "log",
                        "message": "Team member added: {user_id} as {role}",
                    },
                ],
            },
        },
...
def seed_project_mgmt_task_template(library: PatternLibrary):
    ...
    library.add_entity_template(
        ...
        default_patterns={
            ...
            "commenting": {"enable_comments": True, "allow_attachments": True},
        },
        default_actions={
            "assign_task": {
                ...
                "steps": [
                    {
                        ...
                        "error": "Cannot assign completed task",
                    },
                    {
                        "type": "update",
                        "entity": "Task",
            ...
            "add_dependency": {
                ...
                "parameters": [{"name": "depends_on_task_id", "type": "uuid"}],
                "steps": [
                    {
                        "type": "validate",
                        "condition": "depends_on_task_id != $id",
                        "error": "Task cannot depend on itself",
                    },
                    {
                        "type": "validate",
                        "condition": "depends_on_task_id NOT IN depends_on",
                        "error": "Dependency already exists",
                    },
                    {
                        "type": "query",
                        "sql": "SELECT project_id FROM tasks WHERE id = $depends_on_task_id",
                        "into": "dep_project",
                    },
                    {
                        "type": "validate",
                        "condition": "dep_project.project_id == project",
                        "error": "Dependency must be in same project",
                    },
                    {
                        "type": "update",
                        "entity": "Task",
                        "where": "id = $id",
                        "fields": {"depends_on": "depends_on || $depends_on_task_id"},
                    },
                    {
                        "type": "update",
                        "entity": "Task",
                        "where": "id = $depends_on_task_id",
                        "fields": {"blocks": "blocks || $id"},
                    },
            ...
            "log_time": {
                ...
                "steps": [
                    ...
                    },
                    {
                        ...
                        "entity": "Task",
                        "where": "id = $id",
                        "fields": {"actual_hours": "actual_hours + $hours"},
                    },
                    {
                        "type": "create",
                        "entity": "TimeEntry",
                    ...
                    {
                        "type": "log",
                        "message": "Time logged: {hours} hours - {description}",
                    },
                ],
            },
            "add_subtask": {
                "description": "Add subtask to this task",
                "parameters": [{"name": "subtask_data", "type": "object"}],
                "steps": [
                    {
                        "type": "update",
                        "entity": "Task",
                        "where": "id = $id",
                        "fields": {"subtasks": "subtasks || $subtask_data"},
                    },
            ...
            "add_comment": {
                ...
                "parameters": [{"name": "comment", "type": "text"}],
                "steps": [
                    {
                        "type": "update",
                        "entity": "Task",
                        "where": "id = $id",
                        "fields": {
                            "comments": "comments || {'text': $comment, 'user_id': $current_user_id, 'timestamp': NOW()}"
                        },
                    },
    ...
    library.add_entity_template(
        ...
        default_actions={
                ...
                "steps": [
                    {
                        ...
                        "error": "Required tasks must be completed first",
                    },
                    {
                        "type": "validate",
                        "condition": "len([d for d in deliverables if not d.get('completed', False)]) == 0",
                        "error": "All deliverables must be completed",
                    },
                    {
                        "type": "call",
                        "function": "transition_to",
                        "args": {"target_state": "completed"},
                    },
                    {
                        "type": "update",
                        "entity": "Milestone",
                        "where": "id = $id",
                        "fields": {"actual_date": "NOW()", "progress_percentage": 100},
                    },
            ...
            "add_deliverable": {
                ...
                "parameters": [{"name": "deliverable", "type": "text"}],
                "steps": [
                    {
                        "type": "update",
                        "entity": "Milestone",
                        "where": "id = $id",
                        "fields": {
                            "deliverables": "deliverables || {'description': $deliverable, 'completed': False}"
                        },
                    },
            ...
            "complete_deliverable": {
                ...
                "parameters": [{"name": "deliverable_index", "type": "integer"}],
                "steps": [
                    {
                        "type": "update",
                        "entity": "Milestone",
                        "where": "id = $id",
                        "fields": {
                            "deliverables": "update_deliverable_status(deliverables, $deliverable_index, True)"
                        },
                    },
            ...
            "update_progress": {
                ...
                "steps": [
                    {
                        "type": "assign",
                        "variable": "total_deliverables",
                        "value": "len(deliverables)",
                    },
                    {
                        "type": "assign",
                        "variable": "completed_deliverables",
                        "value": "len([d for d in deliverables if d.get('completed', False)])",
                    },
                    {
                        "type": "assign",
                        "variable": "progress",
                        "value": "(completed_deliverables / total_deliverables) * 100 if total_deliverables > 0 else 0",
                    },
                    {
                        "type": "update",
                        "entity": "Milestone",
                        "where": "id = $id",
                        "fields": {"progress_percentage": "$progress"},
                    },
                    {
                        "type": "log",
                        "message": "Milestone progress updated to {progress}%",
                    },
                ],
            },
            "add_required_task": {
                "description": "Add required task for milestone completion",
                "parameters": [{"name": "task_id", "type": "uuid"}],
                "steps": [
                    {
                        "type": "query",
                    ...
                    {
                        "type": "validate",
                        "condition": "task_project.project_id == project",
                        "error": "Task must belong to same project",
                    },
                    {
                        "type": "update",
                        "entity": "Milestone",
                        "where": "id = $id",
                        "fields": {"required_tasks": "required_tasks || $task_id"},
                    },
...
def seed_hr_employee_template(library: PatternLibrary):
    ...
    library.add_entity_template(
        ...
        default_patterns={
            ...
            "hierarchy_navigation": {"parent_field": "manager", "max_depth": 5},
        },
        default_actions={
            "update_performance_rating": {
                ...
                "steps": [
                    ...
                    {
                        "type": "assign",
                        "variable": "next_review",
                        "value": "$review_date + INTERVAL '1 year'",
                    },
                    {
                        "type": "update",
                        "entity": "Employee",
                        "where": "id = $id",
                        "fields": {"next_review_date": "$next_review"},
                    },
                    {
                        "type": "log",
                        "message": "Performance rating updated to {rating}",
                    },
                ],
            },
            "change_position": {
                ...
                "steps": [
                    {
                        "type": "query",
                        "sql": "SELECT department_id FROM positions WHERE id = $new_position_id",
                        "into": "position_info",
                    },
                    {
                        "type": "update",
                        ...
                        "fields": {
                            ...
                            "department": "position_info.department_id",
                        },
                    },
                    {
                        "type": "create",
            ...
            "record_time_off": {
                ...
                "steps": [
                    ...
                    {
                        "type": "if",
                        "condition": "time_off_type == 'vacation'",
                        "then": [
                            {
                                "type": "validate",
                                "condition": "remaining_vacation_days >= days",
                            ...
                            },
                            {
                                ...
                                "where": "id = $id",
                                "fields": {
                                    "used_vacation_days": "used_vacation_days + days"
                                },
                            },
                        ],
                    },
                    {
                        "type": "if",
                        "condition": "time_off_type == 'sick'",
                        "then": [
                            {
                                "type": "validate",
                                "condition": "remaining_sick_days >= days",
                                "error": "Insufficient sick days",
                            },
                            {
                                "type": "update",
                                "entity": "Employee",
                                "where": "id = $id",
                                "fields": {"used_sick_days": "used_sick_days + days"},
                            },
                        ],
                    },
                    {
                    ...
                    {
                        "type": "log",
                        "message": "Time off recorded: {days} days {time_off_type}",
                    },
                ],
            },
...
def seed_hr_position_template(library: PatternLibrary):
    ...
    library.add_entity_template(
        ...
        default_fields={
            ...
            "status": {
                "type": "enum",
                "values": ["open", "filled", "frozen", "eliminated"],
                "default": "open",
            },
        ...
        default_patterns={
            ...
            "hierarchy_navigation": {"parent_field": "reports_to", "max_depth": 10},
        },
        default_actions={
            ...
            "update_compensation": {
                ...
                "steps": [
                    {
                        "type": "validate",
                        "condition": "min_salary <= target_salary <= max_salary",
                        "error": "Target salary must be within range",
                    },
                    {
                        "type": "update",
                        "entity": "Position",
            ...
            "add_requirement": {
                ...
                "parameters": [
                    {
                        ...
                        "type": "enum",
                        "values": ["skill", "education", "experience", "certification"],
                    },
                ...
                "steps": [
                    {
                        "type": "if",
                        "condition": "requirement_type == 'skill'",
                        "then": [
                            {
                                "type": "update",
                                "entity": "Position",
                                "where": "id = $id",
                                "fields": {
                                    "required_skills": "required_skills || $requirement"
                                },
                            }
                        ],
                    },
                    {
                        "type": "if",
                        "condition": "requirement_type == 'education'",
                        "then": [
                            {
                                "type": "update",
                                "entity": "Position",
                                "where": "id = $id",
                                "fields": {
                                    "education_requirements": "education_requirements || $requirement"
                                },
                            }
                        ],
                    },
                    {
                        "type": "if",
                        "condition": "requirement_type == 'certification'",
                        "then": [
                            {
                                "type": "update",
                                "entity": "Position",
                                "where": "id = $id",
                                "fields": {
                                    "certifications": "certifications || $requirement"
                                },
                            }
                        ],
                    },
            ...
            "allocate_budget": {
                ...
                "steps": [
                    ...
                    },
                    {
                        ...
                        "entity": "Department",
                        "where": "id = $id",
                        "fields": {"allocated_budget": "allocated_budget + amount"},
                    },
                    {
                        "type": "create",
                    ...
                    {
                        "type": "log",
                        "message": "Budget allocated: ${amount} for {purpose}",
                    },
                ],
            },
            "update_headcount": {
                ...
                "steps": [
                    {
                        "type": "query",
                        "sql": "SELECT COUNT(*) as employee_count FROM employees WHERE department_id = $id AND employment_status = 'active'",
                        "into": "headcount",
                    },
                    {
                        "type": "query",
                        "sql": "SELECT COUNT(*) as open_count FROM positions WHERE department_id = $id AND status = 'open'",
                        "into": "open_pos",
                    },
                    {
                        "type": "update",
                        ...
                        "where": "id = $id",
                        "fields": {
                            "current_headcount": "headcount.employee_count",
                            "open_positions": "open_pos.open_count",
                        },
                    },
                    {
                        "type": "log",
                        "message": "Headcount updated: {headcount.employee_count} current, {open_pos.open_count} open",
                    },
                ],
            },
            "set_department_head": {
                "description": "Set department head",
                "parameters": [{"name": "employee_id", "type": "uuid"}],
                "steps": [
                    {
                        "type": "query",
                        "sql": "SELECT department_id FROM employees WHERE id = $employee_id",
                        "into": "emp_dept",
                    },
                    {
                        "type": "validate",
                        "condition": "emp_dept.department_id == $id",
                        "error": "Employee must be in this department",
                    },
                    {
                        "type": "update",
                        "entity": "Department",
                        "where": "id = $id",
                        "fields": {"head": "$employee_id"},
                    },
                    {
                        "type": "log",
                        "message": "Department head set to employee {employee_id}",
                    },
                ],
            },
        ...
        default_actions={
            "add_time_entry": {
                ...
                "steps": [
                    {
                        "type": "validate",
                        "condition": "date >= period_start AND date <= period_end",
                        "error": "Date must be within timesheet period",
                    },
                    {
                        "type": "validate",
                        "condition": "hours > 0 AND hours <= 24",
                        "error": "Hours must be between 0 and 24",
                    },
                    {
                        "type": "validate",
                        "condition": "status == 'draft'",
                        "error": "Cannot modify submitted timesheet",
                    },
                    {
                        "type": "update",
                        "entity": "Timesheet",
                        "where": "id = $id",
                        "fields": {
                            "time_entries": "time_entries || {'date': $date, 'hours': $hours, 'project': $project, 'description': $description, 'billable': $billable}"
                        },
                    },
                    {"type": "call", "function": "recalculate_totals"},
                    {
                        "type": "log",
                        "message": "Time entry added: {hours} hours on {date}",
                    },
                ],
            },
            "recalculate_totals": {
                ...
                "steps": [
                    {
                        "type": "assign",
                        "variable": "total",
                        "value": "sum(entry.hours for entry in time_entries)",
                    },
                    {
                        "type": "assign",
                        "variable": "regular",
                    ...
                    },
                    {
                        "type": "assign",
                        "variable": "overtime",
                        "value": "max(total - 40, 0)",
                    },
                    {
                        "type": "assign",
                        "variable": "vacation",
                        "value": "sum(entry.hours for entry in time_entries if entry.get('type') == 'vacation')",
                    },
                    {
                        "type": "assign",
                        "variable": "sick",
                        "value": "sum(entry.hours for entry in time_entries if entry.get('type') == 'sick')",
                    },
                    {
                        "type": "update",
                        "entity": "Timesheet",
                ...
                "steps": [
                    {
                        ...
                        "error": "Timesheet not submitted",
                    },
                    {
                        "type": "call",
                        "function": "transition_to",
                        "args": {"target_state": "approved"},
                    },
                    {
                        "type": "update",
                        "entity": "Timesheet",
        ...
        default_actions={
            "add_line_item": {
                ...
                "steps": [
                    ...
                    },
                    {
                        "type": "assign",
                        "variable": "line_tax",
                        "value": "line_total * (tax_rate or 0)",
                    },
                    {
                        "type": "update",
                        "entity": "Invoice",
                        "where": "id = $id",
                        "fields": {
                            "line_items": "line_items || {'description': $description, 'quantity': $quantity, 'unit_price': $unit_price, 'tax_rate': $tax_rate, 'line_total': $line_total, 'line_tax': $line_tax}"
                        },
                    },
                    {"type": "call", "function": "recalculate_totals"},
                ...
                "steps": [
                    {
                        "type": "assign",
                        "variable": "subtotal",
                        "value": "sum(item.line_total for item in line_items)",
                    },
                    {
                        "type": "assign",
                        "variable": "tax_amount",
                        "value": "sum(item.line_tax for item in line_items)",
                    },
                    {
                        "type": "assign",
                        "variable": "total",
                        "value": "subtotal + tax_amount - discount_amount",
                    },
                    {
                        "type": "update",
                        "entity": "Invoice",
            ...
            "send_invoice": {
                ...
                "steps": [
                    ...
                    },
                    {
                        ...
                        "error": "Cannot send invoice with zero total",
                    },
                    {
                        "type": "call",
                        "function": "transition_to",
                        "args": {"target_state": "sent"},
                    },
            ...
            "record_payment": {
                ...
                "steps": [
                    ...
                    {
                        "type": "if",
                        "condition": "is_fully_paid",
                        "then": [
                            {
                                "type": "call",
                                "function": "transition_to",
                                "args": {"target_state": "paid"},
                            },
                            {
                                "type": "update",
                                "entity": "Invoice",
                                "where": "id = $id",
                                "fields": {"paid_date": "$payment_date"},
                            },
                        ],
                    },
                    {
                ...
                "steps": [
                    {
                        "type": "validate",
                        "condition": "status == 'draft'",
                        "error": "Cannot discount sent invoice",
                    },
                    {
                        "type": "validate",
                    ...
                    {
                        "type": "log",
                        "message": "Discount applied: ${discount_amount} - {reason}",
                    },
                ],
            },
        },
    ...
    library.add_entity_template(
        ...
        default_actions={
                ...
                "steps": [
                    {
                        ...
                        "error": "Payment not in pending status",
                    },
                    {
                        "type": "call",
                        "function": "transition_to",
                        "args": {"target_state": "processing"},
                    },
                    {
                        "type": "update",
                        "entity": "Payment",
                        "where": "id = $id",
                        "fields": {"processed_date": "NOW()"},
                    },
            ...
            "complete_payment": {
                ...
                "parameters": [{"name": "processor_transaction_id", "type": "text"}],
                "steps": [
                    {
                        "type": "call",
                        "function": "transition_to",
                    ...
                    {
                        "type": "log",
                        "message": "Payment completed: {processor_transaction_id}",
                    },
                ],
            },
            "fail_payment": {
            ...
            "refund_payment": {
                ...
                "steps": [
                    {
                        "type": "validate",
                        "condition": "can_refund",
                        "error": "Payment cannot be refunded",
                    },
                    {
                        "type": "validate",
                        "condition": "refund_amount <= refundable_amount",
                    ...
                    {
                        "type": "if",
                        "condition": "refund_amount >= amount",
                        "then": [
                            {
                                "type": "call",
                                "function": "transition_to",
                    ...
                    {
                        "type": "log",
                        "message": "Refund processed: ${refund_amount} - {reason}",
                    },
                ],
            },
            "reconcile_payment": {
...
def seed_finance_transaction_template(library: PatternLibrary):
    ...
    library.add_entity_template(
        ...
        default_fields={
            ...
            "transaction_type": {
                "type": "enum",
                "values": ["income", "expense", "transfer", "adjustment", "fee"],
                "required": True,
            },
            "category": {"type": "text"},
            # Related Entities
            ...
            "status": {
                "type": "enum",
                "values": ["pending", "posted", "reconciled", "voided"],
                "default": "pending",
            },
            "reconciled": {"type": "boolean", "default": False},
            "reconciled_date": {"type": "timestamp"},
        ...
        default_actions={
                ...
                "steps": [
                    ...
                    },
                    {
                        ...
                        "then": [
                            {
                                "type": "validate",
                                "condition": "approved_by IS NOT NULL",
            ...
            "update_account_balances": {
                ...
                "steps": [
                    {
                        "type": "query",
                        "sql": "SELECT balance FROM accounts WHERE id = $debit_account",
                        "into": "debit_balance",
                    },
                    {
                        "type": "query",
                        "sql": "SELECT balance FROM accounts WHERE id = $credit_account",
                        "into": "credit_balance",
                    },
                    {
                        "type": "update",
                        ...
                        "fields": {"balance": "debit_balance.balance + $amount"},
                    },
                    {
                        "type": "update",
                        "entity": "Account",
                        "where": "id = $credit_account",
                        "fields": {"balance": "credit_balance.balance - $amount"},
                    },
            ...
            "void_transaction": {
                ...
                "steps": [
                    {
                        "type": "validate",
                        "condition": "status != 'reconciled'",
                        "error": "Cannot void reconciled transaction",
                    },
                    {
                        "type": "call",
                        "function": "transition_to",
                        "args": {"target_state": "voided"},
                    },
                    {
                        "type": "update",
                        "entity": "Transaction",
                        "where": "id = $id",
                        "fields": {"void_reason": "$reason"},
                    },
            ...
            "approve_transaction": {
                ...
                "steps": [
                    ...
                    },
                    {
                        ...
                        "entity": "Transaction",
                        "where": "id = $id",
                        "fields": {"approved_by": "$current_user_id"},
                    },
                    {
                        "type": "log",
                        "message": "Transaction approved by {current_user_id}",
                    },
                ],
            },
        },
