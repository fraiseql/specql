    ...
    library.add_domain_pattern(
        ...
        parameters={
            ...
            "guards": {
                "type": "object",
                "required": False,
                "description": "Validation rules per transition",
            },
            "initial_state": {
                "type": "string",
                "required": False,
        ...
        implementation={
            "fields": [
                ...
                {"name": "state_changed_at", "type": "timestamp", "default": "NOW()"},
                {"name": "state_changed_by", "type": "uuid"},
            ],
            "actions": [
                {
                    "name": "transition_to",
            ...
            "tables": [
                {
                    ...
                    "fields": [
                        {
                            "name": "pk_{{ entity }}_state_history",
                            "type": "integer",
                            "primary_key": True,
                        },
            ...
            "actions": [
                {
                    ...
                    "steps": [
                        ...
                        },
                        {
                            ...
                            "entity": "{{ entity }}",
                            "where": "id = $id",
                            "fields": {"deleted_at": "NOW()", "deleted_by": "$user_id"},
                        },
                    ],
                },
                {
                    ...
                    "steps": [
                        ...
                        },
                        {
                            ...
                            "entity": "{{ entity }}",
                            "where": "id = $id",
                            "fields": {"deleted_at": "NULL", "deleted_by": "NULL"},
                        },
                    ],
                },
            ],
            ...
            "actions": [
                {
                    ...
                    "steps": [
                        ...
                        },
                        {
                            ...
                            "then": [{"type": "raise", "error": "Validation failed"}],
                        },
                    ],
                }
            ],
                                            ...
                                            "then": [
                                                {
                                                    ...
                                                    "value": {
                                                        "valid": False,
                                                        "error": "$rule.field must be at least $rule.min characters",
                                                    },
                                                }
                                            ],
                                        },
                                            ...
                                            "then": [
                                                {
                                                    ...
                                                    "value": {
                                                        "valid": False,
                                                        "error": "$rule.field must be at most $rule.max characters",
                                                    },
                                                }
                                            ],
                                        },
                                            ...
                                            "then": [
                                                {
                                                    ...
                                                    "value": {
                                                        "valid": False,
                                                        "error": "$rule.field must be at most $rule.max",
                                                    },
                                                }
                                            ],
                                        },
    ...
    library.add_domain_pattern(
        ...
        parameters={
            ...
            "stages": {
                "type": "array",
                "required": True,
                "description": "Approval stages with reviewers",
            },
            "auto_approve_threshold": {
                "type": "number",
                "required": False,
                "description": "Auto-approve if amount below threshold",
            },
            "escalation_days": {
                "type": "number",
                "required": False,
                ...
                },
                {
                    ...
                    "steps": [
                        ...
                        },
                        {
                            ...
                            "entity": "{{ entity }}",
                            "where": "id = $id",
                            "fields": {"approved_by": "approved_by + [$reviewer_id]"},
                        },
                        {
                            "type": "insert",
                            "entity": "{{ entity }}_approval_history",
            ...
            "tables": [
                {
                    ...
                    "fields": [
                        {
                            "name": "pk_{{ entity }}_approval_history",
                            "type": "integer",
                            "primary_key": True,
                        },
                        {"name": "entity_id", "type": "uuid"},
    ...
    library.add_domain_pattern(
        ...
        parameters={
            ...
            "enable_circular_check": {
                ...
                "required": False,
                "default": True,
                "description": "Prevent circular references",
            },
        },
        implementation={
            "fields": [
            ...
            "actions": [
                ...
                {
                    "name": "get_tree",
                    "parameters": [{"name": "root_id", "type": "uuid"}],
                    "steps": [
                        {
                            "type": "query",
                            "sql": """
                                ...
                                "steps": [
                                    {
                                        ...
                                        "where": "id = $update.id",
                                        "fields": {
                                            "hierarchy_level": "$update.new_level"
                                        },
                                    }
                                ],
                            },
            ...
            "triggers": [
                ...
                {"event": "after_insert", "action": "update_hierarchy_path"},
            ],
            "indexes": [
                {
                    "fields": ["{{ parent_field }}"],
                    "name": "idx_{{ entity }}_{{ parent_field }}",
                },
                {
                    "fields": ["hierarchy_level"],
                    "name": "idx_{{ entity }}_hierarchy_level",
                },
                {
                    "fields": ["hierarchy_path"],
                    "name": "idx_{{ entity }}_hierarchy_path",
                    "type": "gin",
                },
            ],
        },
    ...
    library.add_domain_pattern(
        ...
        parameters={
            ...
            "computed_fields": {
                "type": "object",
                "required": True,
                "description": "Field definitions with formulas",
            },
        },
        implementation={
            "actions": [
                    ...
                    "steps": [
                        ...
                        },
                        {
                            ...
                            "args": {
                                ...
                                "formula": "{{ computed_fields }}[$field_name]",
                            },
                            "into": "computed_value",
                        },
                        {
                            ...
                            "steps": [
                                {
                                    ...
                                    "args": {
                                        "record": "$record",
                                        "field_name": "$field_def.key",
                                        "formula": "$field_def.value",
                                    },
                                    "into": "computed_value",
                                },
                                {
                        ...
                        "steps": [
                            {
                                ...
                                "cases": {
                                    ...
                                    "lookup": [
                                        ...
                                        {
                                            "type": "return",
                                            "value": "$lookup_result.$formula.select_field",
                                        },
                                    ],
                                    "concat": [
                                        {
                                ...
                                "default": [{"type": "return", "value": None}],
                            }
                        ]
                    },
                },
            ...
            "triggers": [
                {"event": "after_insert", "action": "compute_all_fields"},
                {
                    "event": "after_update",
    ...
    library.add_domain_pattern(
        ...
        parameters={
            ...
            "search_vector_field": {
                ...
                "description": "Name of search vector field",
            },
            "enable_fuzzy_search": {
                "type": "boolean",
                "required": False,
        ...
        implementation={
            ...
            "triggers": [
                {"event": "after_insert", "action": "update_search_index"},
                {
                    "event": "after_update",
    ...
    library.add_domain_pattern(
        ...
        parameters={
            ...
            "translatable_fields": {
                "type": "array",
                "required": True,
                "description": "Fields that need translation",
            },
            "default_locale": {
                "type": "string",
                "required": False,
        ...
        implementation={
            "tables": [
                {
                    ...
                    "indexes": [
                        {
                            "fields": ["entity_id", "locale"],
                            "name": "idx_{{ entity }}_translations_entity_locale",
                        },
                        {
                            "fields": ["entity_id", "field_name"],
                            "name": "idx_{{ entity }}_translations_entity_field",
                        },
                        {
                            "fields": ["locale"],
                            "name": "idx_{{ entity }}_translations_locale",
                        },
                    ],
                }
            ],
            "actions": [
                ...
                },
                {
                    ...
                    "parameters": [{"name": "entity_id", "type": "uuid"}],
                    "steps": [
                        {
                            "type": "query",
                            "sql": """
    ...
    library.add_domain_pattern(
        ...
        parameters={
            ...
            "max_file_size": {
                ...
                "required": False,
                "default": 10485760,
                "description": "Max file size in bytes (10MB default)",
            },
            "allowed_types": {
                "type": "array",
                "required": False,
        ...
        implementation={
            "tables": [
                {
                    ...
                    "indexes": [
                        {
                            "fields": ["entity_id"],
                            "name": "idx_{{ entity }}_attachments_entity",
                        },
                        {
                            "fields": ["file_hash"],
                            "name": "idx_{{ entity }}_attachments_hash",
                        },
                        {
                            "fields": ["is_current"],
                            "name": "idx_{{ entity }}_attachments_current",
                        },
                        {
                            "fields": ["uploaded_at"],
                            "name": "idx_{{ entity }}_attachments_uploaded_at",
                        },
                    ],
                }
            ],
            "actions": [
                ...
                {
                    "name": "download_file",
                    "parameters": [{"name": "attachment_id", "type": "integer"}],
                    "steps": [
                        {
                            "type": "query",
    ...
    library.add_domain_pattern(
        ...
        parameters={
            ...
            "enable_categories": {
                ...
                "required": False,
                "default": True,
                "description": "Enable tag categories",
            },
            "allow_custom_tags": {
                "type": "boolean",
                "required": False,
            ...
            "max_tags_per_entity": {
                ...
                "required": False,
                "default": 50,
                "description": "Maximum tags per entity",
            },
        },
        implementation={
            "tables": [
                {
                    ...
                    "indexes": [
                        {
                            "fields": ["entity_id"],
                            "name": "idx_{{ entity }}_tags_entity",
                        },
                        {"fields": ["tag_name"], "name": "idx_{{ entity }}_tags_name"},
                        {
                            "fields": ["tag_category"],
                            "name": "idx_{{ entity }}_tags_category",
                        },
                    ],
                },
                {
                    ...
                    "indexes": [
                        {
                            "fields": ["tag_category"],
                            "name": "idx_tag_definitions_category",
                        },
                        {
                            "fields": ["usage_count"],
                            "name": "idx_tag_definitions_usage",
                        },
                    ],
                },
            ],
            "actions": [
                {
                    ...
                    "steps": [
                        ...
                        {"type": "assign", "variable": "tag_color", "value": None},
                        {
                            "type": "if",
                    ...
                    "logic": {
                        "steps": [
                            ...
                            },
                            {
                                ...
                                "else": [{"type": "return", "value": "$existing_def"}],
                            },
                        ]
                    },
                },
    ...
    library.add_domain_pattern(
        ...
        parameters={
            ...
            "enable_threading": {
                ...
                "required": False,
                "default": True,
                "description": "Enable threaded replies",
            },
            "enable_mentions": {
                "type": "boolean",
                "required": False,
            ...
            "tables": [
                {
                    ...
                    "indexes": [
                        {
                            "fields": ["entity_id"],
                            "name": "idx_{{ entity }}_comments_entity",
                        },
                        {
                            "fields": ["parent_comment_id"],
                            "name": "idx_{{ entity }}_comments_parent",
                        },
                        {
                            "fields": ["author_id"],
                            "name": "idx_{{ entity }}_comments_author",
                        },
                        {
                            "fields": ["created_at"],
                            "name": "idx_{{ entity }}_comments_created_at",
                        },
                    ],
                }
            ],
            "actions": [
                {
                    ...
                    "steps": [
                        ...
                        {"type": "assign", "variable": "mentions", "value": []},
                        {
                            "type": "if",
    ...
    library.add_domain_pattern(
        ...
        parameters={
            ...
            "enable_preferences": {
                ...
                "required": False,
                "default": True,
                "description": "Enable user notification preferences",
            },
        },
        implementation={
            "tables": [
                {
                    ...
                    "fields": [
                        {
                            "name": "pk_{{ entity }}_notifications",
                            "type": "integer",
                            "primary_key": True,
                        },
                        {"name": "entity_id", "type": "uuid"},
                    ...
                    "indexes": [
                        {
                            "fields": ["entity_id"],
                            "name": "idx_{{ entity }}_notifications_entity",
                        },
                        {
                            "fields": ["recipient_id"],
                            "name": "idx_{{ entity }}_notifications_recipient",
                        },
                        {
                            "fields": ["is_read"],
                            "name": "idx_{{ entity }}_notifications_read",
                        },
                        {
                            "fields": ["created_at"],
                            "name": "idx_{{ entity }}_notifications_created_at",
                        },
                    ],
                },
                {
                    ...
                    "steps": [
                        {
                            ...
                            "fields": {"is_read": True, "read_at": "NOW()"},
                        }
                    ],
                },
            ],
    ...
    library.add_domain_pattern(
        ...
        parameters={
            ...
            "enable_recurring": {
                ...
                "required": False,
                "default": True,
                "description": "Enable recurring schedules",
            },
            "enable_reminders": {
                "type": "boolean",
                "required": False,
            ...
            "timezone_support": {
                ...
                "required": False,
                "default": True,
                "description": "Support multiple timezones",
            },
        },
        implementation={
            "fields": [
            ...
            "tables": [
                {
                    ...
                    "fields": [
                        {
                            "name": "pk_{{ entity }}_schedule_history",
                            "type": "integer",
                            "primary_key": True,
                        },
                        {"name": "entity_id", "type": "uuid"},
            ...
            "tables": [
                {
                    ...
                    "indexes": [
                        {
                            "fields": ["identifier"],
                            "name": "idx_{{ entity }}_rate_limits_identifier",
                        },
                        {
                            "fields": ["window_start"],
                            "name": "idx_{{ entity }}_rate_limits_window",
                        },
                    ],
                }
            ],
                                    ...
                                    "then": [
                                        {
                                            ...
                                            "value": {
                                                "allowed": False,
                                                "retry_after": "$record.blocked_until",
                                            },
                                        }
                                    ],
                                },
