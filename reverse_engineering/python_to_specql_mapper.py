...
from reverse_engineering.protocols import ParsedEntity, ParsedMethod
from reverse_engineering.python_statement_analyzer import (
    PythonStatement,
...
class PythonToSpecQLMapper:
    ...
    def _map_statement(self, stmt: PythonStatement, entity: ParsedEntity) -> list[ActionStep]:
    ...
    def _map_if_statement(self, stmt: PythonStatement, entity: ParsedEntity) -> list[ActionStep]:
        """
        Map if statement
    ...
    def _map_assign_statement(
        self, stmt: PythonStatement, entity: ParsedEntity
    ) -> list[ActionStep]:
        """
    ...
    def _map_for_statement(self, stmt: PythonStatement, entity: ParsedEntity) -> list[ActionStep]:
        """
        Map for loop
