...
class PythonASTParser:
    ...
    def detect_patterns(self, entity: ParsedEntity) -> list[str]:
        ...
        has_transitions = any(
            "transition" in m.method_name or "set_" in m.method_name for m in entity.methods
        )
    ...
    def _parse_orm_field(self, call_node: ast.Call) -> dict[str, Any] | None:
        ...
        specql_type = django_mapping.get(field_class) or sqlalchemy_mapping.get(field_class)
