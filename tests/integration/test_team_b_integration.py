...
class TestTeamBIntegration:
    ...
    def test_contact_lightweight_integration(self, parser, table_generator, function_generator):
        ...
        assert len(entity.fields) == 6  # email, first_name, last_name, company, status, phone
    ...
    def test_manufacturer_example_integration(self, parser, table_generator):
        ...
        assert "pk_manufacturer INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY" in ddl
