...
def test_generate_contact_entity_production_readiness():
    ...
    assert (
        "pk_contact INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY" in contact_ddl
    )
    ...
    for action_input in action_inputs:
        assert f"CREATE TYPE app.{action_input}" in ddl, (
            f"Should generate {action_input}"
        )
