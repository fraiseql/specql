...
class TestLargeFileSecurity:
    ...
    def test_extremely_large_yaml_file(self, temp_dir, parser):
        ...
        except (MemoryError, ValueError, RuntimeError, Exception):
            # It's OK to reject extremely large files (including SpecQLValidationError)
            pass
...
"""
    ...
    def test_many_actions(self, parser):
        ...
        except (MemoryError, ValueError, RecursionError, Exception):
            # Expected to reject this (including SpecQLValidationError)
            pass
