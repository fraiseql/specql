...
class TestMermaidGenerator:
    ...
    def test_hide_trinity_fields(self):
        ...
        entity = Entity(
            ...
            schema="crm",
            fields={
                "pk_contact": FieldDefinition(
                    name="pk_contact", type_name="uuid", nullable=False
                ),
                "id": FieldDefinition(name="id", type_name="uuid", nullable=False),
                "identifier": FieldDefinition(
                    name="identifier", type_name="text", nullable=False
                ),
                "email": FieldDefinition(
                    name="email", type_name="text", nullable=False
                ),
            ...
            Entity(
                ...
                fields={
                    "author_id": FieldDefinition(
                        name="author_id", type_name="ref(User)", nullable=False
                    ),
                    "editor_id": FieldDefinition(
                        name="editor_id", type_name="ref(User)", nullable=True
                    ),
                },
            ),
        ]
