...
class TestHTMLViewerGenerator:
    def test_generate_basic_html(self):
        ...
        html = generator.generate(
            svg_content=svg_content, output_path=None, title="Test Diagram"
        )
    ...
    def test_custom_title(self):
        ...
        html = generator.generate(
            svg_content=svg_content, output_path=None, title="Custom Title"
        )
            ...
            Entity(
                ...
                fields={
                    "parent_id": FieldDefinition(
                        name="parent_id", type_name="ref(Parent)", nullable=False
                    )
                },
            ),
        ]
