...
from infrastructure.security_pattern_library import SecurityPatternLibrary
...
def reverse_sql(sql_files, output_dir, min_confidence, no_ai, preview, compare, use_heuristics):
    ...
    from cli.reverse import reverse as reverse_cmd
...
def generate_infra(pattern_name, provider, output, dry_run):
    ...
    try:
        if provider == "aws":
            ...
            from infrastructure.generators.azure_security_generator import (
            ...
            from infrastructure.generators.kubernetes_security_generator import (
...
def check_compliance(yaml_file, framework):
    ...
    from infrastructure.parsers.security_parser import SecurityPatternParser
    from infrastructure.universal_infra_schema import CompliancePreset
